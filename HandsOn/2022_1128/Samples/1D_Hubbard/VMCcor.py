...
def main():
    ...
    ini_cnt,max_cnt,calcmode = VMClocal.ReadModpara(modpara)
    ...
    OutputSqSzNqNk(list_org,all_Sq,all_Sz,all_Nq,all_Nk)
    #[e] calc Sq,Sz,Nq,Nk
...
def OutputSqSzNqNk(list_org,all_Sq,all_Sz,all_Nq,all_Nk):
    #[s] Sq,Sz,Nq
    ...
    with open("Nk.dat", 'w') as f:
        for kx in range(-list_org[0],list_org[0]+1):
            if kx <0:
